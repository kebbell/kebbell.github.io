    ...
    getViewPort: function () {
      ...
      return (
        "innerWidth" in window ||
          ((o = "client"), (n = document.documentElement || document.body)),
        { width: n[o + "Width"], height: n[o + "Height"] }
      );
    },
  };
})();
...
const y = (i, e, t) => Math.max(e, Math.min(i, t)),
  P = (i) => {
  ...
  A = (i, e, t = (n) => n, s) => {
    ...
    for (let a = 0; a < i.length; a += 1) {
      ...
      let f = 0,
        m = 0;
      for (let h = g; h < p && h < i.length; h += 1) (m += n(i[h])), (f += 1);
      o[a] = s ? s(i[a], m / f) : m / f;
    }
    return o;
  },
  B = (i) => i.reduce((e, t) => e + t, 0) / i.length,
  E = (i, e = 10) => {
    const t = Math.max(0, i.length - e);
    return i.slice(t);
  },
  _ = Math.PI * 2,
  v = 0.75,
...
class x {
  ...
  set playbackSpeed(e) {
    this.draggingSpeeds.push(e),
      (this.draggingSpeeds = E(this.draggingSpeeds, 10)),
      (this._playbackSpeed = A(this.draggingSpeeds)),
      (this._playbackSpeed = B(this.draggingSpeeds)),
      (this._playbackSpeed = y(this._playbackSpeed, -4, 4));
  }
  get secondsPlayed() {
    return this.angle / S / v;
  }
  get duration() {
    return this._duration;
  }
  set duration(e) {
    (this._duration = e), (this.maxAngle = e * v * S);
  }
  set isDragging(e) {
    (this._isDragging = e), this.el.classList.toggle("is-scratching", e);
  }
  get isDragging() {
    return this._isDragging;
  }
  powerOn() {
    (this._isPoweredOn = !0), (this._playbackSpeed = 1), this.start();
  }
  powerOff() {
    (this._isPoweredOn = !1), this.stop();
  }
  onDragStart(e) {
  ...
  onDragProgress(e) {
    ...
    const { clientX: t, clientY: s } = e,
      n = { x: t, y: s },
      o = w(this.center, n),
      a = w(this.center, this.draggingFrom),
      l = R(a, o);
  ...
  autoRotate(e) {
    ...
    let s = b * t * this.playbackSpeed;
    (s += 0.1), (s = y(s, 0, b * t)), this.setAngle(this.angle + s);
  }
  setState() {
    this.el.style.transform = `rotate(${this.angle}rad)`;
  }
  setAngle(e) {
    return (this.angle = y(e, 0, this.maxAngle)), this.angle;
  }
  start() {
    (this.timestampPrevious = performance.now()), this.loop();
  }
  stop() {
    cancelAnimationFrame(this.rafId), this.callbacks.onStop();
  }
  rewind() {
    this.setAngle(0);
  }
  loop() {
    ...
    const t = e - this.timestampPrevious,
      s = this.angle - this.anglePrevious,
      n = b * t;
    (this.playbackSpeed = s / n || 0),
...
class O {
  ...
  onKeyDown({ key: e, repeat: t }) {
    t || e !== k || this.callbacks.onToggleMuted(!0);
  }
  onKeyUp({ key: e }) {
    e === k && this.callbacks.onToggleMuted(!1);
  }
  toggle() {
...
const r = new x(document.querySelector("#disc")),
  c = new T(),
  d = new O({
  ...
  I = async () => {
    await c.loadTrack(
      ...
      (r.callbacks.onStop = () => c.pause()),
      (r.callbacks.onDragEnded = () => {
        d.isPlaying && c.play(r.secondsPlayed);
      }),
      (r.callbacks.onLoop = ({
        playbackSpeed: i,
        isReversed: e,
      ...
      (d.callbacks.onIsplayingChanged = (i) => {
        i ? (r.powerOn(), c.play(r.secondsPlayed)) : r.powerOff();
      }),
      (d.callbacks.onRewind = () => {
        r.rewind();
      }),
      (d.callbacks.onToggleMuted = (i) => {
        c.toggleMute(i);
      });
  };
I();
